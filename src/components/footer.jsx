...
import { Copyright,  InIcon, TwIcon } from "../assets/Icons";
      ...
      <div className="mt-[63px] flex flex-col md:flex md:flex-row justify-between items-center ">
        <div className="flex items-center gap-[10px]">
          ...
          <p className={`text-[#FFFFFF99] md:text-xl text-lg font-medium`}>
            Ummkhalad AbdulRasheed<span> {new Date().getFullYear()} </span>
          </p>
        </div>
        <div className="mt-[35px] md:mt-[65px] flex justify-start items-center  gap-[26px] md:gap-[40px]">
          <motion.a
            href="https://twitter.com/_just_omaah"
            target="_blank"
            rel="noreferrer"
            whileTap={{ scale: 1.1 }}
          ...
          <motion.a
            href="https://www.linkedin.com/in/ummkhalad-oluwatosin/"
            target="_blank"
            rel="noreferrer"
            whileTap={{ scale: 1.1 }}
            whileHover={{ scale: 0.99 }}
